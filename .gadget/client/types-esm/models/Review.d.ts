...
import { Query, PromiseOrLiveIterator, Review, AvailableReviewSelection, ReviewSort, ReviewFilter } from "../types.js";
...
*/
export type SelectedReviewOrDefault<Options extends Selectable<AvailableReviewSelection>> = DeepFilterNever<Select<Review, DefaultSelection<AvailableReviewSelection, Options, typeof DefaultReviewSelection>>>;
/**
 ...
 * ```
 */
export type ReviewRecord<Selection extends AvailableReviewSelection | undefined = typeof DefaultReviewSelection> = DeepFilterNever<GadgetRecord<SelectedReviewOrDefault<{
    select: Selection;
}>>>;
export declare const DefaultReviewSelection: {
...
declare const modelApiIdentifier: "review";
declare const pluralModelApiIdentifier: "reviews";
...
/**
 * A manager for the review model with all the available operations for reading and writing to it.*/
export declare const ReviewManager: {
