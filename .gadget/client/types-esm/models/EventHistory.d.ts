...
import { Query, IDsList, PromiseOrLiveIterator, EventHistory, AvailableEventHistorySelection, EventHistorySort, EventHistoryFilter } from "../types.js";
...
*/
export type SelectedEventHistoryOrDefault<Options extends Selectable<AvailableEventHistorySelection>> = DeepFilterNever<Select<EventHistory, DefaultSelection<AvailableEventHistorySelection, Options, typeof DefaultEventHistorySelection>>>;
/**
 ...
 * ```
 */
export type EventHistoryRecord<Selection extends AvailableEventHistorySelection | undefined = typeof DefaultEventHistorySelection> = DeepFilterNever<GadgetRecord<SelectedEventHistoryOrDefault<{
    select: Selection;
}>>>;
export declare const DefaultEventHistorySelection: {
...
declare const modelApiIdentifier: "eventHistory";
declare const pluralModelApiIdentifier: "eventHistories";
 ...
 **/
export type CreateEventHistoryResult<Options extends CreateEventHistoryOptions> = SelectedEventHistoryOrDefault<Options> extends void ? void : GadgetRecord<SelectedEventHistoryOrDefault<Options>>;
/**
...
export type EventHistoryManager = {
    ...
    create: {
        ...
        **/
        <Options extends CreateEventHistoryOptions>(id: string, options?: LimitToKnownKeys<Options, CreateEventHistoryOptions>): Promise<CreateEventHistoryResult<Options>>;
        type: 'action';
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateEventHistoryOptions>(ids: string[], options?: LimitToKnownKeys<Options, CreateEventHistoryOptions>): Promise<CreateEventHistoryResult<Options>[]>;
        type: 'action';
...
/**
 * A manager for the eventHistory model with all the available operations for reading and writing to it.*/
export declare const EventHistoryManager: {
