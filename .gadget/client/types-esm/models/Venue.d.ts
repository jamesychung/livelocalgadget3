...
import { Query, IDsList, PromiseOrLiveIterator, Venue, AvailableVenueSelection, VenueSort, VenueFilter, CreateVenueInput, UpdateVenueInput, Scalars, UpsertVenueInput } from "../types.js";
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertVenueVariables = Omit<UpsertVenueInput, "on"> & {
    on?: ((Scalars['String'] | null))[];
};
/**
...
export type VenueManager = {
    ...
    create: {
        ...
        * * const result = await api.venue.create({
          ...
          * });
        **/
        <Options extends CreateVenueOptions>(variables: CreateVenueVariables, options?: LimitToKnownKeys<Options, CreateVenueOptions>): Promise<CreateVenueResult<Options>>;
        /**
         * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        ...
        * * const result = await api.venue.create({
          ...
          * });
        **/
        <Options extends CreateVenueOptions>(variables: FullyQualifiedCreateVenueVariables, options?: LimitToKnownKeys<Options, CreateVenueOptions>): Promise<CreateVenueResult<Options>>;
        type: 'action';
        ...
        variablesType: (((FullyQualifiedCreateVenueVariables | CreateVenueVariables)) | undefined);
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateVenueOptions>(inputs: (FullyQualifiedCreateVenueVariables | CreateVenueVariables)[], options?: LimitToKnownKeys<Options, CreateVenueOptions>): Promise<any[]>;
        type: 'action';
    ...
    update: {
        ...
        * * const result = await api.venue.update("1", {
          ...
          * });
        **/
        <Options extends UpdateVenueOptions>(id: string, variables: UpdateVenueVariables, options?: LimitToKnownKeys<Options, UpdateVenueOptions>): Promise<UpdateVenueResult<Options>>;
        /**
         * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const result = await api.venue.update("1", {
          ...
          * });
        **/
        <Options extends UpdateVenueOptions>(id: string, variables: FullyQualifiedUpdateVenueVariables, options?: LimitToKnownKeys<Options, UpdateVenueOptions>): Promise<UpdateVenueResult<Options>>;
        type: 'action';
    ...
    bulkUpdate: {
        /**
          ...
          */
        <Options extends UpdateVenueOptions>(inputs: (FullyQualifiedUpdateVenueVariables | UpdateVenueVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateVenueOptions>): Promise<any[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpdateVenuesInput!]';
            };
        };
        variablesType: (FullyQualifiedUpdateVenueVariables | UpdateVenueVariables & {
            id: string;
        })[];
        paramOnlyVariables: [];
        selectionType: AvailableVenueSelection;
    ...
    findFirst: {
        ...
        **/
        <Options extends FindFirstVenueOptions>(id: string, options?: LimitToKnownKeys<Options, FindFirstVenueOptions>): Promise<FindFirstVenueResult<Options>>;
        type: 'action';
    ...
    bulkFindFirst: {
        /**
          ...
          */
        <Options extends FindFirstVenueOptions>(ids: string[], options?: LimitToKnownKeys<Options, FindFirstVenueOptions>): Promise<any[]>;
        type: 'action';
    ...
    upsert: {
        ...
        * * const result = await api.venue.upsert({
          ...
          * });
        **/
        <Options extends UpsertVenueOptions>(variables: UpsertVenueVariables, options?: LimitToKnownKeys<Options, UpsertVenueOptions>): Promise<UpsertVenueResult<Options>>;
        /**
         * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const result = await api.venue.upsert({
          ...
          * });
        **/
        <Options extends UpsertVenueOptions>(variables: FullyQualifiedUpsertVenueVariables, options?: LimitToKnownKeys<Options, UpsertVenueOptions>): Promise<UpsertVenueResult<Options>>;
        type: 'action';
        ...
        variablesType: (((FullyQualifiedUpsertVenueVariables | UpsertVenueVariables)) | undefined);
        hasAmbiguousIdentifier: false;
        paramOnlyVariables: ['on'];
        hasReturnType: {
            '... on CreateVenueResult': {
                hasReturnType: true;
            };
            '... on UpdateVenueResult': {
                hasReturnType: true;
            };
        };
        acceptsModelInput: true;
    ...
    bulkUpsert: {
        /**
          ...
          */
        <Options extends UpsertVenueOptions>(inputs: (FullyQualifiedUpsertVenueVariables | UpsertVenueVariables)[], options?: LimitToKnownKeys<Options, UpsertVenueOptions>): Promise<any[]>;
        type: 'action';
