...
import { Query, IDsList, PromiseOrLiveIterator, Event, AvailableEventSelection, EventSort, EventFilter, CreateEventInput, UpdateEventInput, Scalars, UpsertEventInput } from "../types.js";
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertEventVariables = Omit<UpsertEventInput, "on"> & {
    on?: ((Scalars['String'] | null))[];
};
/**
...
export type EventManager = {
    ...
    create: {
        ...
        * * const result = await api.event.create({
          ...
          * });
        **/
        <Options extends CreateEventOptions>(variables: CreateEventVariables, options?: LimitToKnownKeys<Options, CreateEventOptions>): Promise<CreateEventResult<Options>>;
        /**
         * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        ...
        * * const result = await api.event.create({
          ...
          * });
        **/
        <Options extends CreateEventOptions>(variables: FullyQualifiedCreateEventVariables, options?: LimitToKnownKeys<Options, CreateEventOptions>): Promise<CreateEventResult<Options>>;
        type: 'action';
        ...
        variablesType: (((FullyQualifiedCreateEventVariables | CreateEventVariables)) | undefined);
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateEventOptions>(inputs: (FullyQualifiedCreateEventVariables | CreateEventVariables)[], options?: LimitToKnownKeys<Options, CreateEventOptions>): Promise<any[]>;
        type: 'action';
    ...
    update: {
        ...
        * * const result = await api.event.update("1", {
          ...
          * });
        **/
        <Options extends UpdateEventOptions>(id: string, variables: UpdateEventVariables, options?: LimitToKnownKeys<Options, UpdateEventOptions>): Promise<UpdateEventResult<Options>>;
        /**
         * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const result = await api.event.update("1", {
          ...
          * });
        **/
        <Options extends UpdateEventOptions>(id: string, variables: FullyQualifiedUpdateEventVariables, options?: LimitToKnownKeys<Options, UpdateEventOptions>): Promise<UpdateEventResult<Options>>;
        type: 'action';
    ...
    bulkUpdate: {
        /**
          ...
          */
        <Options extends UpdateEventOptions>(inputs: (FullyQualifiedUpdateEventVariables | UpdateEventVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateEventOptions>): Promise<any[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpdateEventsInput!]';
            };
        };
        variablesType: (FullyQualifiedUpdateEventVariables | UpdateEventVariables & {
            id: string;
        })[];
        paramOnlyVariables: [];
        selectionType: AvailableEventSelection;
    ...
    findFirst: {
        ...
        **/
        <Options extends FindFirstEventOptions>(id: string, options?: LimitToKnownKeys<Options, FindFirstEventOptions>): Promise<FindFirstEventResult<Options>>;
        type: 'action';
    ...
    bulkFindFirst: {
        /**
          ...
          */
        <Options extends FindFirstEventOptions>(ids: string[], options?: LimitToKnownKeys<Options, FindFirstEventOptions>): Promise<any[]>;
        type: 'action';
    ...
    upsert: {
        ...
        * * const result = await api.event.upsert({
          ...
          * });
        **/
        <Options extends UpsertEventOptions>(variables: UpsertEventVariables, options?: LimitToKnownKeys<Options, UpsertEventOptions>): Promise<UpsertEventResult<Options>>;
        /**
         * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const result = await api.event.upsert({
          ...
          * });
        **/
        <Options extends UpsertEventOptions>(variables: FullyQualifiedUpsertEventVariables, options?: LimitToKnownKeys<Options, UpsertEventOptions>): Promise<UpsertEventResult<Options>>;
        type: 'action';
        ...
        variablesType: (((FullyQualifiedUpsertEventVariables | UpsertEventVariables)) | undefined);
        hasAmbiguousIdentifier: false;
        paramOnlyVariables: ['on'];
        hasReturnType: {
            '... on CreateEventResult': {
                hasReturnType: true;
            };
    ...
    bulkUpsert: {
        /**
          ...
          */
        <Options extends UpsertEventOptions>(inputs: (FullyQualifiedUpsertEventVariables | UpsertEventVariables)[], options?: LimitToKnownKeys<Options, UpsertEventOptions>): Promise<any[]>;
        type: 'action';
