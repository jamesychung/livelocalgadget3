...
import {
  ...
  EventApplication,
  AvailableEventApplicationSelection,
  EventApplicationSort,
...
*/
export type SelectedEventApplicationOrDefault<Options extends Selectable<AvailableEventApplicationSelection>> = DeepFilterNever<
    Select<
      EventApplication,
      DefaultSelection<
        AvailableEventApplicationSelection,
        Options,
        typeof DefaultEventApplicationSelection
      >
    >
  >;
 ...
 * ```
 */
export type EventApplicationRecord<Selection extends AvailableEventApplicationSelection | undefined = typeof DefaultEventApplicationSelection> = DeepFilterNever<
  GadgetRecord<
    SelectedEventApplicationOrDefault<{
      select: Selection;
    }>
  >
>;

export const DefaultEventApplicationSelection = {
     __typename: true,
     id: true,
     appliedAt: true,
     createdAt: true,
...
const modelApiIdentifier = "eventApplication" as const;
const pluralModelApiIdentifier = "eventApplications" as const;
 ...
 **/
export type CreateEventApplicationResult<Options extends CreateEventApplicationOptions> = SelectedEventApplicationOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedEventApplicationOrDefault<Options>>;
...
export type EventApplicationManager = {
  ...
  create: {
      ...
      **/
      <Options extends CreateEventApplicationOptions>(
        id: string,
      
        options?: LimitToKnownKeys<Options, CreateEventApplicationOptions>
      ): Promise<CreateEventApplicationResult<Options>>;
      type: 'action';
...
/**
 * A manager for the eventApplication model with all the available operations for reading and writing to it.*/
export const EventApplicationManager = buildModelManager(
  modelApiIdentifier,
