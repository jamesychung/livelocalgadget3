-- Add a separate column to track who requested the cancellation
ALTER TABLE bookings
  ADD COLUMN IF NOT EXISTS cancel_requested_by_role TEXT;

-- Update the trigger function to handle both roles correctly
