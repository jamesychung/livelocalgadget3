-- Fix any existing bookings that have selected_at set but still have status "booked"
-- This can happen if the trigger didn't work correctly during the enum update

-- Note: The enum migration should have already converted 'booked' to 'selected'
-- This migration just ensures the trigger is working correctly

-- Also ensure the trigger function is working correctly by recreating it
