 ...
 */ /**
 * @internal
 */ /** The options for the mail object being sent */ /** The body of the email in plain text */ /** The body of the email in HTML */ /** The From address displayed to users as to who the email came from. If using Gadget transport, must end in the app's approved subdomain, the value of primaryDomain found in Config. If one is not provided then a default address for the app will be used */ /** The Sender header used to identify the agent responsible for the actual transmission of the email. Can only be set when using a Custom transport */ /** An array of attachments */ export { }; /** the filename of the attachment. If not provided, will be derived from the path */  /** path to a file */  /** the content of the attachment */ 
