...
*/
export type SelectedMusicianOrDefault<Options extends Selectable<AvailableMusicianSelection>> = DeepFilterNever<
    Select<
      Musician,
      DefaultSelection<
        AvailableMusicianSelection,
        Options,
        typeof DefaultMusicianSelection
      >
    >
  >;
 ...
 * ```
 */
export type MusicianRecord<Selection extends AvailableMusicianSelection | undefined = typeof DefaultMusicianSelection> = DeepFilterNever<
  GadgetRecord<
    SelectedMusicianOrDefault<{
      select: Selection;
    }>
  >
>;

export const DefaultMusicianSelection = {
     __typename: true,
     id: true,
     availability: true,
     bio: true,
...
const modelApiIdentifier = "musician" as const;
const pluralModelApiIdentifier = "musicians" as const;
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertMusicianVariables = Omit<
     UpsertMusicianInput,
     "on"
   > & {
     on?: ((Scalars['String'] | null))[];
...
export type MusicianManager = {
  ...
  create: {
      ...
      * * const result = await api.musician.create({
        ...
        * });
      **/
      <Options extends CreateMusicianOptions>(
      
        variables: CreateMusicianVariables,
        options?: LimitToKnownKeys<Options, CreateMusicianOptions>
      ): Promise<CreateMusicianResult<Options>>;
      /**
       * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
      *
      ...
      **/
      <Options extends CreateMusicianOptions>(
        ...
        variables: FullyQualifiedCreateMusicianVariables,
        options?: LimitToKnownKeys<Options, CreateMusicianOptions>
      ): Promise<CreateMusicianResult<Options>>;
      type: 'action';
      ...
      variablesType: ((
               ...
               & (FullyQualifiedCreateMusicianVariables | CreateMusicianVariables)
             ) | undefined);
  ...
  bulkCreate: {
      /**
        ...
        */
       <Options extends CreateMusicianOptions>(
          inputs: (FullyQualifiedCreateMusicianVariables | CreateMusicianVariables)[],
          options?: LimitToKnownKeys<Options, CreateMusicianOptions>
       ): Promise<any[]>
      type: 'action';
  ...
  update: {
      ...
      * * const result = await api.musician.update("1", {
        ...
        * });
      **/
      <Options extends UpdateMusicianOptions>(
        id: string,
        variables: UpdateMusicianVariables,
        options?: LimitToKnownKeys<Options, UpdateMusicianOptions>
      ): Promise<UpdateMusicianResult<Options>>;
      /**
       * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
      *
      * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
      ...
      **/
      <Options extends UpdateMusicianOptions>(
        id: string,
        variables: FullyQualifiedUpdateMusicianVariables,
        options?: LimitToKnownKeys<Options, UpdateMusicianOptions>
      ): Promise<UpdateMusicianResult<Options>>;
      type: 'action';
  ...
  bulkUpdate: {
      /**
        ...
        */
       <Options extends UpdateMusicianOptions>(
          inputs: (FullyQualifiedUpdateMusicianVariables | UpdateMusicianVariables & { id: string })[],
          options?: LimitToKnownKeys<Options, UpdateMusicianOptions>
       ): Promise<any[]>
      type: 'action';
      ...
      variablesType: (FullyQualifiedUpdateMusicianVariables | UpdateMusicianVariables & { id: string })[];
      paramOnlyVariables: [];
      selectionType: AvailableMusicianSelection;
      schemaType: Query["musician"];
      defaultSelection: typeof DefaultMusicianSelection;
  ...
  findFirst: {
      ...
      **/
      <Options extends FindFirstMusicianOptions>(
        id: string,
      
        options?: LimitToKnownKeys<Options, FindFirstMusicianOptions>
      ): Promise<FindFirstMusicianResult<Options>>;
      type: 'action';
  ...
  upsert: {
      ...
      * * const result = await api.musician.upsert({
        ...
        * });
      **/
      <Options extends UpsertMusicianOptions>(
      
        variables: UpsertMusicianVariables,
        options?: LimitToKnownKeys<Options, UpsertMusicianOptions>
      ): Promise<UpsertMusicianResult<Options>>;
      /**
       * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
      *
      * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
      ...
      **/
      <Options extends UpsertMusicianOptions>(
        ...
        variables: FullyQualifiedUpsertMusicianVariables,
        options?: LimitToKnownKeys<Options, UpsertMusicianOptions>
      ): Promise<UpsertMusicianResult<Options>>;
      type: 'action';
      ...
      variablesType: ((
               ...
               & (FullyQualifiedUpsertMusicianVariables | UpsertMusicianVariables)
             ) | undefined);
      hasAmbiguousIdentifier: false;
  ...
  bulkUpsert: {
      /**
        ...
        */
       <Options extends UpsertMusicianOptions>(
          inputs: (FullyQualifiedUpsertMusicianVariables | UpsertMusicianVariables)[],
          options?: LimitToKnownKeys<Options, UpsertMusicianOptions>
       ): Promise<any[]>
      type: 'action';
...
/**
 * A manager for the musician model with all the available operations for reading and writing to it.*/
export const MusicianManager = buildModelManager(
  modelApiIdentifier,
